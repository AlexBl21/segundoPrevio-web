...
import co.edu.ufps.CopaMundial.entities.Seleccion;
...
public class ProjectController {
	...
	@PostMapping()
	public ResponseEntity<Project> create(@RequestBody Project seleccion) {
		Project nuevaSeleccion = projectService.update(seleccion);
